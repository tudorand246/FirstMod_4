...
public class ModItems
{
    ...
    public static final RegistryObject<Item> BLOCK_1 = ITEMS.register("block_element",
            () -> new Item(new Item.Properties().tab(ModCreativeTab.FIRST_TAB)));

    public static final RegistryObject<Item> PARM = ITEMS.register("p_arm",
            () -> new Item(new Item.Properties().tab(ModCreativeTab.FIRST_TAB)));

    public static final RegistryObject<Item> LSLIDE = ITEMS.register("lin_slide",
            () -> new Item(new Item.Properties().tab(ModCreativeTab.FIRST_TAB)));
    ...
    public static final RegistryObject<Item> DT_2 = ITEMS.register("tank_dt",
            () -> new Item(new Item.Properties().tab(ModCreativeTab.FIRST_TAB)));
